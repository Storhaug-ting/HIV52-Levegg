**Til:** Trond Nessestrand `trond.nessestrand@gmail.com` og Therese Nessestrand (HIV 50) · Hugo Wilhelmsen `hugowilh@gmail.com` og Lill Kristin Hagen `lilhagen@gmail.com` (HIV 54) · Trekanten AS v/Geir Moen `geir@moen-as.no` (HIV 56) · Hanne Kjersti Vikeby `hannek1988@hotmail.com` og Andreas Takvam (HIV 58)
**Kopi:** Sigrid Storhaug `sigrid_e85@hotmail.com`
**Emne:** Levegger mellom boligene i rekka – forslag til felles utforming

---

Hei alle sammen,

Vi går med tanken om å sette opp levegger mellom boligene i rekka vår, og ønsker å høre hva dere
tenker før vi tar saken videre til styret.

Uteplassene våre på østsiden ligger i dag helt åpne mot hverandre. Det fungerer på et vis, men i
praksis sitter vi alle i hverandres synsfelt, og det begrenser bruken av uteplassene mer enn
nødvendig. En levegg mellom hver bolig løser dette for begge parter samtidig.

Vi sender denne til alle fem husstandene i rekka, ikke bare til dem vi grenser til selv. Grunnen er
enkel: hvis vi setter opp én vegg nå, én om to år og én til om fem, ender vi lett opp med fire
forskjellige løsninger i samme husrekke. Blir vi enige om utformingen én gang, kan hver enkelt vegg
settes opp når det passer for de to som deler den – uten at det ser tilfeldig ut.

## De fire veggene

| Vegg | Mellom | Parter |
|------|--------|--------|
| A | HIV 50 og HIV 52 | Trond og Therese · Marius og Sigrid |
| B | HIV 52 og HIV 54 | Marius og Sigrid · Hugo og Lill |
| C | HIV 54 og HIV 56 | Hugo og Lill · Trekanten AS |
| D | HIV 56 og HIV 58 | Trekanten AS · Andreas og Hanne |

HIV 56 er ikke solgt ennå, så Trekanten AS er part i vegg C og D inntil videre. Vi tenker det er en
fordel å få utformingen avklart nå, slik at en framtidig kjøper overtar noe som allerede er på
plass framfor å måtte ta saken opp på nytt.
...
| Vegg | Mellom | Avstand til bakken | Alternativ 1 | Alternativ 2 |
|------|--------|--------------------|--------------|--------------|
| A | 50 og 52 | 4,10 m | 4,10 m | 3,10 m |
| B | 52 og 54 | 5,30 m | 5,00 m | 4,30 m |
| C | 54 og 56 | 4,10 m | 4,10 m | 3,10 m |
| D | 56 og 58 | 5,00 m | 5,00 m | 4,00 m |
...
samme eiendom ikke skal vurderes samlet som ett søknadspliktig tiltak.

## Tett eller spaltet vegg – et poeng vi ikke hadde tenkt på

Vi har lest oss opp på hva [SINTEF Byggforsk][byggforsk] anbefaler for levegger i vindutsatte
omgivelser, og det var overraskende: **en helt tett vegg er ikke det beste valget.** Luften som
passerer over toppen slår ned igjen et stykke bak veggen, og der blir det kastevind. Le-sonen bak en
tett vegg rekker bare 9–13 meter. En vegg som slipper gjennom litt luft gir jevnere le, og den
...
Vi har ingen hast, og veggene trenger ikke settes opp samtidig. Hver vegg gjennomføres når det
passer for de to som deler den. Kostnaden deles mellom de to partene til hver vegg, og vi blir
enkelt enige om fordelingen. Sameiet belastes ikke.
